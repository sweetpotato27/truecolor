...
// This will be user to redirect the user to the login page upon signup
...
// when our user is logged out, we will dispatch this action to set 
// isAuthentication to false
